<template>
  <div class="my-10">
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-4xl font-black dark:text-gray-400">Watchlist</h2>
      ...
      <div>
        <button
          ...
          class="rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 dark:ring-offset-gray-800 focus:ring-blue-500"
    ...
    >
      <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <div
            class="overflow-hidden border-b border-gray-200 shadow dark:border-gray-900 sm:rounded-lg"
          >
            <table
            ...
            >
              <thead class="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th
                    scope="col"
                    class="px-6 py-3 text-xs tracking-wider text-left text-gray-500 uppercase dark:text-gray-400"
                  ></th>
                  <th
                    scope="col"
              ...
              <tbody>
                <tr
                  class="odd:bg-white dark:odd:bg-gray-700 even:bg-gray-50 dark:even:bg-gray-900"
                ...
                >
                  ...
                  <td
                    class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-200 whitespace-nowrap"
                  >
                    {{ movie.title }}
                  </td>
                  <td
                    class="px-6 py-4 text-sm text-right text-gray-500 dark:text-gray-400 whitespace-nowrap"
                  >
                    {{ formatPrice(movie.price) }}
                  </td>
                  <td
                    class="px-6 py-4 text-sm text-center text-gray-500 dark:text-gray-400 whitespace-nowrap"
                  >
